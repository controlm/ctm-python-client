...
@attrs.define
class ConnectionProfileApplicationIntegratorAISimplePlugin(ConnectionProfileApplicationIntegrator):

    _type: str = attrs.field(init=False, default='ConnectionProfile:ApplicationIntegrator:AI Simple Plugin', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:ApplicationIntegrator:AI Simple Plugin'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    ...
    ai_host: str = attrs.field(kw_only=True, default=None, metadata={
                                '_aapi_repr_': 'AI-Host'})
    ai_machine_password: str = attrs.field(kw_only=True, default=None, metadata={
                                            '_aapi_repr_': 'AI-Machine Password'})
