...
@attrs.define
class ConnectionProfileIBMMQ(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:IBM MQ', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:IBM MQ'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    ...
    i_b_m_m_q_console_url: str = attrs.field(kw_only=True, default=None, metadata={
                                               '_aapi_repr_': 'IBM MQ Console URL'})
    queue_manager_name: str = attrs.field(kw_only=True, default=None, metadata={
                                          '_aapi_repr_': 'Queue Manager Name'})
    queue_name: str = attrs.field(kw_only=True, default=None, metadata={
                                  '_aapi_repr_': 'Queue Name'})
    api_version: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'API_Version'})
...
@attrs.define
class ConnectionProfileSAPIntegrationSuite(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:SAP Integration Suite', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:SAP Integration Suite'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    action: str = attrs.field(kw_only=True, default=None, metadata={
                              '_aapi_repr_': 'Action'})
    authentication_url: str = attrs.field(kw_only=True, default=None, metadata={
                                            '_aapi_repr_': 'Authentication URL'})
    integration_flow_client_id: str = attrs.field(kw_only=True, default=None, metadata={
                                                  '_aapi_repr_': 'Integration Flow Client ID'})
    integration_flow_client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                                      '_aapi_repr_': 'Integration Flow Client Secret'})
    api_url: str = attrs.field(kw_only=True, default=None, metadata={
                                   '_aapi_repr_': 'API URL'})
    api_client_id: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'API Client ID'})
    api_client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'API Client Secret'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
    rerun_interval: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Rerun Interval'})
...
@attrs.define
class ConnectionProfileSAPBuildProcessAutomation(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:SAP Build Process Automation', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:SAP Build Process Automation'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    token_url: str = attrs.field(kw_only=True, default=None, metadata={
                                   '_aapi_repr_': 'Token URL'})
...
@attrs.define
class ConnectionProfileAwsRDS(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:AWS RDS', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:AWS RDS'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    aws_r_d_s_url: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'AWS RDS URL'})
    aws_region: str = attrs.field(kw_only=True, default=None, metadata={
                                  '_aapi_repr_': 'AWS Region'})
    authentication: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Authentication'})
    ...
    master_username: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'Master Username'})
    master_user_password: str = attrs.field(kw_only=True, default=None, metadata={
                                            '_aapi_repr_': 'Master User Password'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
    rerun_interval: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Rerun Interval'})
...
@attrs.define
class ConnectionProfileSAPIBP(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:SAP IBP', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:SAP IBP'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    host: str = attrs.field(kw_only=True, default=None,
                            metadata={'_aapi_repr_': 'Host'})
    service_url: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Service URL'})
...
@attrs.define
class ConnectionProfileAwsAutoScalingGroups(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:AWS Auto Scaling Groups', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:AWS Auto Scaling Groups'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    auto_scaling_groups_url: str = attrs.field(kw_only=True, default=None, metadata={
                                                 '_aapi_repr_': 'Auto Scaling Groups URL'})
    ec2_url: str = attrs.field(kw_only=True, default=None, metadata={
                                  '_aapi_repr_': 'EC2 URL'})
...
@attrs.define
class ConnectionProfileAzureVirtualMachineScaleSets(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Azure Virtual Machine Scale Sets', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Azure Virtual Machine Scale Sets'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    identity_type: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Identity Type'})
    ...
    azure_login_url: str = attrs.field(kw_only=True, default=None, metadata={
                                         '_aapi_repr_': 'Azure Login URL'})
    virtual_machine_scale_set_url: str = attrs.field(
        kw_only=True, default=None, metadata={'_aapi_repr_': 'Virtual Machine Scale Set URL'})
    virtual_machine_scale_set_resource: str = attrs.field(kw_only=True, default=None, metadata={
                                                          '_aapi_repr_': 'Virtual Machine Scale Set Resource'})
    subscription_id: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'Subscription ID'})
    resource_group: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Resource Group'})
    token_file_location: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Token File Location'})
    connection_timeout: str = attrs.field(kw_only=True, default=None, metadata={
                                          '_aapi_repr_': 'Connection Timeout'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
...
@attrs.define
class ConnectionProfileMicrosoftPowerAutomate(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Microsoft Power Automate', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Microsoft Power Automate'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    power_automate_url: str = attrs.field(kw_only=True, default=None, metadata={
                                            '_aapi_repr_': 'Power Automate URL'})
...
@attrs.define
class ConnectionProfileDataiku(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Dataiku', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Dataiku'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    dataiku_d_s_s_url: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Dataiku DSS URL'})
    api_secret_key: str = attrs.field(kw_only=True, default=None, metadata={
                                        '_aapi_repr_': 'API Secret Key'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
    rerun_attempts: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Rerun Attempts'})
...
class ConnectionProfileAzureVM(ConnectionProfile):
    ...
    resource_group: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Resource Group'})
    vm_resource: str = attrs.field(kw_only=True, default=None, metadata={
                                    '_aapi_repr_': 'VM Resource'})
    tenant_id: str = attrs.field(kw_only=True, default=None, metadata={
                                 '_aapi_repr_': 'Tenant ID'})
    application_id: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Application ID'})
...
@attrs.define
class ConnectionProfileArgoWorkflows(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Argo Workflows', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Argo Workflows'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    argo_server_url: str = attrs.field(kw_only=True, default=None, metadata={
                                         '_aapi_repr_': 'Argo Server URL'})
    argo_bearer_token: str = attrs.field(kw_only=True, default=None, metadata={
                                         '_aapi_repr_': 'Argo Bearer Token'})
    connection_timeout: str = attrs.field(kw_only=True, default=None, metadata={
                                          '_aapi_repr_': 'Connection Timeout'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
...
class ConnectionProfileAwsMWAA(ConnectionProfile):
    ...
    assume_role_session: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Assume Role Session'})
    idp_token_url: str = attrs.field(kw_only=True, default=None, metadata={
                                         '_aapi_repr_': 'IDP Token URL'})
    idp_client_id: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'IDP Client ID'})
    idp_client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'IDP Client Secret'})
    idp_scope: str = attrs.field(kw_only=True, default=None, metadata={
                                   '_aapi_repr_': 'IDP Scope'})
    aws_s_t_s_endpoint_url: str = attrs.field(kw_only=True, default=None, metadata={
                                                '_aapi_repr_': 'AWS STS Endpoint URL'})
    s_t_s_iam_role_arn: str = attrs.field(kw_only=True, default=None, metadata={
                                              '_aapi_repr_': 'STS IAM Role ARN'})
    s_t_s_iam_role_session_name: str = attrs.field(
        kw_only=True, default=None, metadata={'_aapi_repr_': 'STS IAM Role Session Name'})
    connection_timeout: str = attrs.field(kw_only=True, default=None, metadata={
                                          '_aapi_repr_': 'Connection Timeout'})
...
@attrs.define
class ConnectionProfileSAPDatasphere(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:SAP Datasphere', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:SAP Datasphere'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
...
@attrs.define
class ConnectionProfileJDEdwardsEnterpriseOne(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:JD Edwards EnterpriseOne', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:JD Edwards EnterpriseOne'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    j_d_e_hostname_url: str = attrs.field(kw_only=True, default=None, metadata={
                                            '_aapi_repr_': 'JDE Hostname URL'})
    authentication_type: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Authentication Type'})
    username: str = attrs.field(kw_only=True, default=None, metadata={
                                '_aapi_repr_': 'Username'})
    ...
    client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Client Secret'})
    id_p_token_url: str = attrs.field(kw_only=True, default=None, metadata={
                                        '_aapi_repr_': 'IdP Token URL'})
    scope: str = attrs.field(kw_only=True, default=None, metadata={
                             '_aapi_repr_': 'Scope'})
    connection_timeout: str = attrs.field(kw_only=True, default=None, metadata={
...
class ConnectionProfileMicrosoftFabric(ConnectionProfile):
    ...
    connection_timeout: str = attrs.field(kw_only=True, default=None, metadata={
                                          '_aapi_repr_': 'Connection Timeout'})
    request_timeout: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'Request Timeout'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
    rerun_interval: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Rerun Interval'})
...
@attrs.define
class ConnectionProfileGCPManagedInstanceGroups(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:GCP Managed Instance Groups', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:GCP Managed Instance Groups'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    authentication_method: str = attrs.field(kw_only=True, default=None, metadata={
                                             '_aapi_repr_': 'Authentication Method'})
    managed_instance_groups_url: str = attrs.field(
        kw_only=True, default=None, metadata={'_aapi_repr_': 'Managed Instance Groups URL'})
    service_account_key: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Service Account Key'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
...
@attrs.define
class ConnectionProfileOCIDataTransforms(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:OCI Data Transforms', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:OCI Data Transforms'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    oci_data_transform_url: str = attrs.field(
        kw_only=True, default=None, metadata={'_aapi_repr_': 'OCI Data Transform URL'})
    hostname: str = attrs.field(kw_only=True, default=None, metadata={
    ...
    cloud_database_name: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Cloud Database Name'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
    rerun_interval: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Rerun Interval'})
...
@attrs.define
class ConnectionProfileAzureAIFoundry(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Azure AI Foundry', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Azure AI Foundry'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    foundry_url: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Foundry URL'})
    resource_name: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Resource Name'})
    identity_type: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Identity Type'})
    api_key: str = attrs.field(kw_only=True, default=None, metadata={
                                 '_aapi_repr_': 'API Key'})
    ...
    client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Client Secret'})
    workload_identity_token_parameter: str = attrs.field(kw_only=True, default=None, metadata={
                                                         '_aapi_repr_': 'Workload Identity Token Parameter'})
    http_codes: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'HTTP Codes'})
    rerun_interval: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Rerun Interval'})
...
@attrs.define
class ConnectionProfileApacheKafkaViaConfluent(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Apache Kafka via Confluent', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Apache Kafka via Confluent'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    kafka_deployment: str = attrs.field(kw_only=True, default=None, metadata={
                                        '_aapi_repr_': 'Kafka Deployment'})
    kafka_cluster_url: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Kafka Cluster URL'})
    cluster_id: str = attrs.field(kw_only=True, default=None, metadata={
                                  '_aapi_repr_': 'Cluster ID'})
    kafka_authentication_endpoint: str = attrs.field(kw_only=True, default=None, metadata={
                                                     '_aapi_repr_': 'Kafka Authentication Endpoint'})
    confluent_authentication_method: str = attrs.field(kw_only=True, default=None, metadata={
                                                       '_aapi_repr_': 'Confluent Authentication Method'})
    api_key_id: str = attrs.field(kw_only=True, default=None, metadata={
...
@attrs.define
class ConnectionProfileSnowflakeCortexAI(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Snowflake Cortex AI', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Snowflake Cortex AI'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    snowflake_url: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'Snowflake URL'})
    account_identifier: str = attrs.field(kw_only=True, default=None, metadata={
    ...
    authentication_type: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Authentication Type'})
    snowflake_oauth_client_id: str = attrs.field(kw_only=True, default=None, metadata={
                                                 '_aapi_repr_': 'Snowflake Oauth Client ID'})
    snowflake_oauth_client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                                     '_aapi_repr_': 'Snowflake Oauth Client Secret'})
    refresh_token: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Refresh Token'})
    redirect_url: str = attrs.field(kw_only=True, default=None, metadata={
                                      '_aapi_repr_': 'Redirect URL'})
    ...
    client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Client Secret'})
    identity_provider_url: str = attrs.field(kw_only=True, default=None, metadata={
                                               '_aapi_repr_': 'Identity Provider URL'})
    scope: str = attrs.field(kw_only=True, default=None, metadata={
                             '_aapi_repr_': 'Scope'})
    access_token: str = attrs.field(kw_only=True, default=None, metadata={
                                    '_aapi_repr_': 'Access Token'})
...
class ConnectionProfileAnsibleAWX(ConnectionProfile):
    ...
    ansible_url_api_path: str = attrs.field(kw_only=True, default=None, metadata={
                                                '_aapi_repr_': 'Ansible URL API Path'})
...
class ConnectionProfileAtlassianJira(ConnectionProfile):
    ...
    authentication_type: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Authentication Type'})
    jira_api_url: str = attrs.field(kw_only=True, default=None, metadata={
                                        '_aapi_repr_': 'Jira API URL'})
    cloud_id: str = attrs.field(kw_only=True, default=None, metadata={
                                '_aapi_repr_': 'Cloud ID'})
    service_account_email: str = attrs.field(kw_only=True, default=None, metadata={
                                             '_aapi_repr_': 'Service Account Email'})
    s_p_api_token: str = attrs.field(kw_only=True, default=None, metadata={
                                       '_aapi_repr_': 'SP API Token'})
    client_id: str = attrs.field(kw_only=True, default=None, metadata={
                                 '_aapi_repr_': 'Client ID'})
    client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Client Secret'})
...
@attrs.define
class ConnectionProfileOracleFusionCloudESS(ConnectionProfile):

    _type: str = attrs.field(init=False, default='ConnectionProfile:Oracle Fusion Cloud ESS', metadata={
                             '_aapi_repr_': 'Type', '_type_aapi_': 'ConnectionProfile:Oracle Fusion Cloud ESS'})
    object_name: str = attrs.field(metadata={'_aapi_name_': True})
    oracle_fusion_cloud_e_s_s_url: str = attrs.field(
        kw_only=True, default=None, metadata={'_aapi_repr_': 'Oracle Fusion Cloud ESS URL'})
    authentication_type: str = attrs.field(kw_only=True, default=None, metadata={
                                           '_aapi_repr_': 'Authentication Type'})
    username: str = attrs.field(kw_only=True, default=None, metadata={
                                '_aapi_repr_': 'Username'})
    password: str = attrs.field(kw_only=True, default=None, metadata={
                                '_aapi_repr_': 'Password'})
    access_token_url: str = attrs.field(kw_only=True, default=None, metadata={
                                          '_aapi_repr_': 'Access Token URL'})
    client_id: str = attrs.field(kw_only=True, default=None, metadata={
                                 '_aapi_repr_': 'Client ID'})
    client_secret: str = attrs.field(kw_only=True, default=None, metadata={
                                     '_aapi_repr_': 'Client Secret'})
