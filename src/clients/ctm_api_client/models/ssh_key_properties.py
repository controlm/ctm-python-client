...
class SshKeyProperties(object):
    ...
    def __init__(self, key_name=None, key_passphrase=None, key_size=2048, local_vars_configuration=None):  # noqa: E501
        """SshKeyProperties - a model defined in OpenAPI"""  # noqa: E501
