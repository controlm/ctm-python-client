...
class AgentDetailsList(object):
    ...
    def __init__(self, agents=None, local_vars_configuration=None):  # noqa: E501
        """AgentDetailsList - a model defined in OpenAPI"""  # noqa: E501
