...
class RunResult(object):
    ...
    def __init__(self, run_id=None, status_uri=None, monitor_page_uri=None, local_vars_configuration=None):  # noqa: E501
        """RunResult - a model defined in OpenAPI"""  # noqa: E501
