...
class PossibleValueProperties(object):
    ...
    def __init__(self, label=None, label_id=None, value=None, local_vars_configuration=None):  # noqa: E501
        """PossibleValueProperties - a model defined in OpenAPI"""  # noqa: E501
