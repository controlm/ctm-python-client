...
class ConnectionProfileStatus(object):
    ...
    def __init__(self, name=None, type=None, description=None, time_modified=None, time_created=None, creator_name=None, modifier_name=None, sync_status=None, local_vars_configuration=None):  # noqa: E501
        """ConnectionProfileStatus - a model defined in OpenAPI"""  # noqa: E501
