...
class StatisticsAverageInfo(object):
    ...
    def __init__(self, start_time=None, cpu_time=None, run_time=None, local_vars_configuration=None):  # noqa: E501
        """StatisticsAverageInfo - a model defined in OpenAPI"""  # noqa: E501
