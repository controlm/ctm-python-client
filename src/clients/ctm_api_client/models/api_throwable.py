...
class ApiThrowable(object):
    ...
    def __init__(self, localized_message=None, message=None, local_vars_configuration=None):  # noqa: E501
        """ApiThrowable - a model defined in OpenAPI"""  # noqa: E501
