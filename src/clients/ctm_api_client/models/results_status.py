...
class ResultsStatus(object):
    ...
    def __init__(self, display_usage=None, message=None, messages=None, return_code=None, local_vars_configuration=None):  # noqa: E501
        """ResultsStatus - a model defined in OpenAPI"""  # noqa: E501
