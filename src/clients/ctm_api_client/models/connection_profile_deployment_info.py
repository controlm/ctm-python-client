...
class ConnectionProfileDeploymentInfo(object):
    ...
    def __init__(self, ctm_name=None, status=None, status_code=None, last_update=None, message=None, local_vars_configuration=None):  # noqa: E501
        """ConnectionProfileDeploymentInfo - a model defined in OpenAPI"""  # noqa: E501
