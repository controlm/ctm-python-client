...
class VariableNameValue(object):
    ...
    def __init__(self, variable_name=None, variable_value=None, local_vars_configuration=None):  # noqa: E501
        """VariableNameValue - a model defined in OpenAPI"""  # noqa: E501
