...
class UserGroupPropertiesData(object):
    ...
    def __init__(self, name=None, external_users=None, ldap_groups=None, ldap_users=None, local_vars_configuration=None):  # noqa: E501
        """UserGroupPropertiesData - a model defined in OpenAPI"""  # noqa: E501
