...
class AgentInHostgroup(object):
    ...
    def __init__(self, host=None, application_type=None, tag=None, hostgroup_agent_participation=None, participation_rules=None, local_vars_configuration=None):  # noqa: E501
        """AgentInHostgroup - a model defined in OpenAPI"""  # noqa: E501
