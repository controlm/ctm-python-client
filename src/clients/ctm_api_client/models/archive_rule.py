...
class ArchiveRule(object):
    ...
    def __init__(self, name=None, description=None, max_output_size=None, max_output_size_type=None, trim_type=None, retention=None, retention_type=None, is_active=None, archived_type=None, rule_parameters=None, local_vars_configuration=None):  # noqa: E501
        """ArchiveRule - a model defined in OpenAPI"""  # noqa: E501
    ...
    def rule_parameters(self, rule_parameters):
        ...
        :type rule_parameters: list[RuleCriteria]
        """
