...
class ResourceObj(object):
    ...
    def __init__(self, name=None, ctm=None, available=None, max=None, workload_policy=None, local_vars_configuration=None):  # noqa: E501
        """ResourceObj - a model defined in OpenAPI"""  # noqa: E501
