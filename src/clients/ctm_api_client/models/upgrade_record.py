...
class UpgradeRecord(object):
    ...
    def __init__(self, upgrade_id=None, ctm=None, agent=None, package=None, from_version=None, to_version=None, activity=None, status=None, message=None, creation_time=None, transfer_start_time=None, transfer_end_time=None, install_start_time=None, install_end_time=None, activity_name=None, install_user=None, notify_address=None, description=None, external_java_path=None, local_vars_configuration=None):  # noqa: E501
        """UpgradeRecord - a model defined in OpenAPI"""  # noqa: E501
