...
class AlertStatusParam(object):
    ...
    def __init__(self, alert_ids=None, status=None, local_vars_configuration=None):  # noqa: E501
        """AlertStatusParam - a model defined in OpenAPI"""  # noqa: E501
