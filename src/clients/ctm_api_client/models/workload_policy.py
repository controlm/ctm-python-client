...
class WorkloadPolicy(object):
    ...
    def __init__(self, name=None, state=None, order_no=None, last_update=None, updated_by=None, description=None, local_vars_configuration=None):  # noqa: E501
        """WorkloadPolicy - a model defined in OpenAPI"""  # noqa: E501
