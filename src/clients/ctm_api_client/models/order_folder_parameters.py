...
class OrderFolderParameters(object):
    ...
    def __init__(self, ctm=None, folder=None, jobs=None, library=None, create_duplicate=None, hold=None, ignore_criteria=None, independent_flow=None, order_date=None, order_into_folder=None, wait_for_order_date=None, variables=None, local_vars_configuration=None):  # noqa: E501
        """OrderFolderParameters - a model defined in OpenAPI"""  # noqa: E501
    ...
    def variables(self, variables):
        ...
        :type variables: list[dict(str, str)]
        """
