...
class MFTExternalUserProjectionData(object):
    ...
    def __init__(self, name=None, company=None, is_locked=None, lock_reason=None, allowed_folders_names=None, local_vars_configuration=None):  # noqa: E501
        """MFTExternalUserProjectionData - a model defined in OpenAPI"""  # noqa: E501
