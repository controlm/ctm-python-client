...
class CtmagentCtmTestType(object):
    ...
    def __init__(self, title=None, result=None, message=None, user_action=None, command=None, command_output=None, advanced=None, ordinal=None, local_vars_configuration=None):  # noqa: E501
        """CtmagentCtmTestType - a model defined in OpenAPI"""  # noqa: E501
