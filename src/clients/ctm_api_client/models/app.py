...
class App(object):
    ...
    def __init__(self, displayname=None, name=None, desc=None, default_type=None, last_modified=None, created_on=None, created_by=None, local_vars_configuration=None):  # noqa: E501
