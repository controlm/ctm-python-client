...
class Summary(object):
    ...
    def __init__(self, total_number_of_jobs=None, total_data_size=None, actual_db_size=None, disk_usage=None, local_vars_configuration=None):  # noqa: E501
