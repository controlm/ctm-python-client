...
class PluginMngAuth(object):
    ...
    def __init__(self, controlm_server=None, agent=None, plugin_type=None, privilege=None, local_vars_configuration=None):  # noqa: E501
        """PluginMngAuth - a model defined in OpenAPI"""  # noqa: E501
