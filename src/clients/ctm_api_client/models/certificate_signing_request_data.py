...
class CertificateSigningRequestData(object):
    ...
    def __init__(self, organization=None, organization_unit=None, city_locality=None, state_province=None, country=None, email_address=None, local_vars_configuration=None):  # noqa: E501
        """CertificateSigningRequestData - a model defined in OpenAPI"""  # noqa: E501
