...
class GatewayData(object):
    ...
    def __init__(self, host=None, port=None, status=None, message=None, local_vars_configuration=None):  # noqa: E501
        """GatewayData - a model defined in OpenAPI"""  # noqa: E501
