...
class ParticipationTime(object):
    ...
    def __init__(self, all_hours=None, between_time=None, local_vars_configuration=None):  # noqa: E501
        """ParticipationTime - a model defined in OpenAPI"""  # noqa: E501
