...
class RuleProjectionData(object):
    ...
    def __init__(self, description=None, last_updated_timestamp=None, name=None, priority=None, search_tags=None, status=None, rule_type=None, local_vars_configuration=None):  # noqa: E501
        """RuleProjectionData - a model defined in OpenAPI"""  # noqa: E501
