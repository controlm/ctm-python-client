...
class CtmvarErrorInfo(object):
    ...
    def __init__(self, ctmvar_del_error_code=None, ctmvar_get_error_code=None, ctmvar_set_error_code=None, variable_name=None, local_vars_configuration=None):  # noqa: E501
        """CtmvarErrorInfo - a model defined in OpenAPI"""  # noqa: E501
    ...
    def ctmvar_del_error_code(self, ctmvar_del_error_code):
        ...
        :type ctmvar_del_error_code: str
        """
        allowed_values = ["FailedDeletingFromDB", "PoolNameInvalid", "UnKnownDelError", "UNRECOGNIZED"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and ctmvar_del_error_code not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def ctmvar_get_error_code(self, ctmvar_get_error_code):
        ...
        :type ctmvar_get_error_code: str
        """
        ...
        if self.local_vars_configuration.client_side_validation and ctmvar_get_error_code not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def ctmvar_set_error_code(self, ctmvar_set_error_code):
        ...
        :type ctmvar_set_error_code: str
        """
        ...
        if self.local_vars_configuration.client_side_validation and ctmvar_set_error_code not in allowed_values:  # noqa: E501
            raise ValueError(
