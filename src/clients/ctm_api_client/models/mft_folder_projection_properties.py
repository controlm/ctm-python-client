...
class MFTFolderProjectionProperties(object):
    ...
    def __init__(self, name=None, allowed_internal_user_names=None, allowed_user_names=None, allowed_group_names=None, access_type=None, local_vars_configuration=None):  # noqa: E501
        """MFTFolderProjectionProperties - a model defined in OpenAPI"""  # noqa: E501
