...
class UserData(object):
    ...
    def __init__(self, name=None, description=None, full_name=None, authentication=None, roles=None, authorization=None, local_vars_configuration=None):  # noqa: E501
