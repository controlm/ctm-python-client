...
class AllowedJobActions(object):
    ...
    def __init__(self, view_properties=None, documentation=None, log=None, statistics=None, view_output_list=None, view_jcl=None, why=None, hold=None, free=None, confirm=None, rerun=None, react=None, restart=None, kill=None, bypass=None, delete=None, undelete=None, set_to_ok=None, edit_properties=None, edit_jcl=None, local_vars_configuration=None):  # noqa: E501
        """AllowedJobActions - a model defined in OpenAPI"""  # noqa: E501
