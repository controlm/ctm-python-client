...
class LogParams(object):
    ...
    def __init__(self, ctm=None, order_id=None, number_of_runs=None, log_table=None, local_vars_configuration=None):  # noqa: E501
        """LogParams - a model defined in OpenAPI"""  # noqa: E501
