...
import clients.ctm_api_client.models
from clients.ctm_api_client import rest
from clients.ctm_api_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clients.ctm_api_client.models, klass)
